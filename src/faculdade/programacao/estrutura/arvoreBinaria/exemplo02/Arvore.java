package faculdade.programacao.estrutura.arvoreBinaria.exemplo02;

public class Arvore {
    private Nodo root; // raiz

    public Arvore() { root=null; } // inicializa arvore

    public void inserir(long v) {
        Nodo novo = new Nodo(); // cria um novo Nó
    ...
    public Nodo buscar(long chave) {
        if (root == null) return null; // se arvore vazia
        Nodo atual = root;  // começa a procurar desde raiz
    ...
    public boolean remover(long v) {
        ...
        // Se possui mais de um filho, se for um avô ou outro grau maior de parentesco
            ...
            Nodo sucessor = no_sucessor(atual);
    ...
    public Nodo no_sucessor(Nodo apaga) { // O parametro é a referencia para o No que deseja-se apagar
        Nodo paidosucessor = apaga;
        Nodo sucessor = apaga;
        Nodo atual = apaga.dir; // vai para a subarvore a direita
    ...
    public void preOrder(Nodo atual) {
        if (atual != null) {
            System.out.print(atual.item + " ");
            preOrder(atual.esq);
            preOrder(atual.dir);
    ...
    public void posOrder(Nodo atual) {
        if (atual != null) {
            posOrder(atual.esq);
            posOrder(atual.dir);
            System.out.print(atual.item + " ");
